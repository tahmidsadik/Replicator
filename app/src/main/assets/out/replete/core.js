...
replete.core.cenv = cljs.env.default_compiler_env.cljs$core$IFn$_invoke$arity$0();
replete.core.load_core_cache = (function replete$core$load_core_cache(core_transit){
var r = cognitect.transit.reader.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"json","json",1279968570));
var core_cache = cognitect.transit.read(r,core_transit);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(replete.core.cenv,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.analyzer","namespaces","cljs.analyzer/namespaces",-260788927),new cljs.core.Symbol(null,"cljs.core","cljs.core",770546058,null)], null),core_cache);

return null;
});
goog.exportSymbol('replete.core.load_core_cache', replete.core.load_core_cache);
replete.core.load_macros_cache = (function replete$core$load_macros_cache(macros_transit){
var r = cognitect.transit.reader.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"json","json",1279968570));
var macros_cache = cognitect.transit.read(r,macros_transit);
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(replete.core.cenv,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword("cljs.analyzer","namespaces","cljs.analyzer/namespaces",-260788927),new cljs.core.Symbol(null,"cljs.core$macros","cljs.core$macros",-2057787548,null)], null),macros_cache);

return null;
});
goog.exportSymbol('replete.core.load_macros_cache', replete.core.load_macros_cache);
...
var G__8292 = replete.core.app_env;
var G__8293 = replete.core.map_keys(cljs.core.keyword,cljs.core.js__GT_clj.cljs$core$IFn$_invoke$arity$1(app_env));
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__8292,G__8293) : cljs.core.reset_BANG_.call(null,G__8292,G__8293));
});
...
var _STAR_data_readers_STAR_8297 = cljs.tools.reader._STAR_data_readers_STAR_;
cljs.tools.reader._STAR_data_readers_STAR_ = cljs.tagged_literals._STAR_cljs_data_readers_STAR_;

try{var env__5589__auto__ = replete.core.cenv;
var env__5589__auto____$1 = ((cljs.core.map_QMARK_(env__5589__auto__))?(cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(env__5589__auto__) : cljs.core.atom.call(null,env__5589__auto__)):((((env__5589__auto__ instanceof cljs.core.Atom)) && (cljs.core.map_QMARK_((cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(env__5589__auto__) : cljs.core.deref.call(null,env__5589__auto__)))))?env__5589__auto__:(function(){throw (new Error([cljs.core.str("Compiler environment must be a map or atom containing a map, not "),cljs.core.str(cljs.core.type(env__5589__auto__))].join('')))})()
));
var _STAR_compiler_STAR_8298 = cljs.env._STAR_compiler_STAR_;
cljs.env._STAR_compiler_STAR_ = env__5589__auto____$1;

try{try{replete.core.repl_read_string(line);

return true;
}catch (e8299){var _ = e8299;
return false;
}}finally {cljs.env._STAR_compiler_STAR_ = _STAR_compiler_STAR_8298;
}}finally {cljs.tools.reader._STAR_data_readers_STAR_ = _STAR_data_readers_STAR_8297;
}});
...
var and__4149__auto__ = cljs.core.seq_QMARK_(form);
if(and__4149__auto__){
var G__8303 = cljs.core.first(form);
return (replete.core.repl_specials.cljs$core$IFn$_invoke$arity$1 ? replete.core.repl_specials.cljs$core$IFn$_invoke$arity$1(G__8303) : replete.core.repl_specials.call(null,G__8303));
} else {
...
var _STAR_cljs_ns_STAR_8318 = cljs.analyzer._STAR_cljs_ns_STAR_;
var _STAR_ns_STAR_8319 = cljs.core._STAR_ns_STAR_;
var _STAR_data_readers_STAR_8320 = cljs.tools.reader._STAR_data_readers_STAR_;
...
var _STAR_compiler_STAR_8321 = cljs.env._STAR_compiler_STAR_;
cljs.env._STAR_compiler_STAR_ = env__5589__auto____$1;
...
var G__8323 = cljs.core.first(form);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"in-ns","in-ns",-2089468466,null),G__8323)){
var G__8324 = replete.core.current_ns;
var G__8325 = cljs.core.second(cljs.core.second(form));
return (cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2 ? cljs.core.reset_BANG_.cljs$core$IFn$_invoke$arity$2(G__8324,G__8325) : cljs.core.reset_BANG_.call(null,G__8324,G__8325));
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"doc","doc",-741138878,null),G__8323)){
if(cljs.core.truth_((function (){var G__8326 = cljs.core.second(form);
return (replete.core.repl_specials.cljs$core$IFn$_invoke$arity$1 ? replete.core.repl_specials.cljs$core$IFn$_invoke$arity$1(G__8326) : replete.core.repl_specials.call(null,G__8326));
})())){
return cljs.repl.print_doc(replete.core.repl_special_doc(cljs.core.second(form)));
} else {
var var_ast = cljs.analyzer.analyze.cljs$core$IFn$_invoke$arity$2(env,cljs.core.sequence.cljs$core$IFn$_invoke$arity$1(cljs.core.seq(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core._conj(cljs.core.List.EMPTY,new cljs.core.Symbol(null,"var","var",870848730,null)),cljs.core._conj(cljs.core.List.EMPTY,cljs.core.second(form))))));
var var_js = (function (){var sb__5116__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR_8327_8332 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_8328_8333 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_8327_8332,_STAR_print_fn_STAR_8328_8333,sb__5116__auto__,var_ast,G__8323,_,form,env,_STAR_compiler_STAR_8321,env__5589__auto__,env__5589__auto____$1,_STAR_cljs_ns_STAR_8318,_STAR_ns_STAR_8319,_STAR_data_readers_STAR_8320){
return (function (x__5117__auto__){
return sb__5116__auto__.append(x__5117__auto__);
});})(_STAR_print_newline_STAR_8327_8332,_STAR_print_fn_STAR_8328_8333,sb__5116__auto__,var_ast,G__8323,_,form,env,_STAR_compiler_STAR_8321,env__5589__auto__,env__5589__auto____$1,_STAR_cljs_ns_STAR_8318,_STAR_ns_STAR_8319,_STAR_data_readers_STAR_8320))
;

try{var val__5595__auto___8334 = cljs.env._STAR_compiler_STAR_;
if((val__5595__auto___8334 == null)){
cljs.env._STAR_compiler_STAR_ = cljs.env.default_compiler_env.cljs$core$IFn$_invoke$arity$0();
} else {
}

try{cljs.compiler.emit(var_ast);
}finally {if((val__5595__auto___8334 == null)){
cljs.env._STAR_compiler_STAR_ = null;
} else {
}
}}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_8328_8333;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_8327_8332;
}
return [cljs.core.str(sb__5116__auto__)].join('');
})();
var var_ret = eval(var_js);
return cljs.repl.print_doc(cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.meta(var_ret),new cljs.core.Keyword(null,"doc","doc",1913296891),(cljs.core.truth_(replete.core.user_interface_idiom_ipad_QMARK_())?cljs.core.identity:replete.core.reflow)));
}
} else {
...
var js = (function (){var sb__5116__auto__ = (new goog.string.StringBuffer());
var _STAR_print_newline_STAR_8329_8335 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR_8330_8336 = cljs.core._STAR_print_fn_STAR_;
cljs.core._STAR_print_newline_STAR_ = true;

cljs.core._STAR_print_fn_STAR_ = ((function (_STAR_print_newline_STAR_8329_8335,_STAR_print_fn_STAR_8330_8336,sb__5116__auto__,___$1,ast,___$2,_,form,env,_STAR_compiler_STAR_8321,env__5589__auto__,env__5589__auto____$1,_STAR_cljs_ns_STAR_8318,_STAR_ns_STAR_8319,_STAR_data_readers_STAR_8320){
return (function (x__5117__auto__){
return sb__5116__auto__.append(x__5117__auto__);
});})(_STAR_print_newline_STAR_8329_8335,_STAR_print_fn_STAR_8330_8336,sb__5116__auto__,___$1,ast,___$2,_,form,env,_STAR_compiler_STAR_8321,env__5589__auto__,env__5589__auto____$1,_STAR_cljs_ns_STAR_8318,_STAR_ns_STAR_8319,_STAR_data_readers_STAR_8320))
;

try{var val__5595__auto___8337 = cljs.env._STAR_compiler_STAR_;
if((val__5595__auto___8337 == null)){
cljs.env._STAR_compiler_STAR_ = cljs.env.default_compiler_env.cljs$core$IFn$_invoke$arity$0();
} else {
}

try{cljs.compiler.emit(ast);
}finally {if((val__5595__auto___8337 == null)){
cljs.env._STAR_compiler_STAR_ = null;
} else {
}
}}finally {cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR_8330_8336;

cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR_8329_8335;
}
return [cljs.core.str(sb__5116__auto__)].join('');
})();
...
}catch (e8331){if((e8331 instanceof Error)){
var e = e8331;
cljs.core._STAR_e = e;
...
}catch (e8322){if((e8322 instanceof Error)){
var e = e8322;
...
}}finally {cljs.env._STAR_compiler_STAR_ = _STAR_compiler_STAR_8321;
}}finally {cljs.tools.reader._STAR_data_readers_STAR_ = _STAR_data_readers_STAR_8320;

cljs.core._STAR_ns_STAR_ = _STAR_ns_STAR_8319;

cljs.analyzer._STAR_cljs_ns_STAR_ = _STAR_cljs_ns_STAR_8318;
}});
